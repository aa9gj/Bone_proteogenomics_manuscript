...
write.table(coloc_sqtl_sig_pc, file = "coloc_sig_pc_events", quote = F, row.names = F)
...
write.table(genes_in_hfobs_and_coloc, "genes_in_hfobs_coloc", quote = F, row.names = F, col.names = F)
